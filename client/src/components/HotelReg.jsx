...
const HotelReg = () => {
  ...
  return (
    <div
      ...
      className="fixed top-0 bottom-0 left-0 right-0 z-20 flex items-center
    justify-center bg-black/70"
    >
      <form
        onSubmit={onSubmitHandler}
        onClick={(e) => e.stopPropagation()}
        className="flex bg-[var(--white-one)] rounded-xl max-w-4xl max-md:mx-2"
      >
        <img
          src={assets.regImage}
          alt="reg-image"
        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
          <img
            ...
            onClick={() => setShowHotelReg(false)}
          />
          <p className="text-2xl font-semibold mt-6 text-[var(--black-one)]">
            Register Your Hotel
          </p>
          ...
          <div className="w-full mt-4 max-w-60 mr-auto">
            ...
            <select
              ...
              rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 '
              required
            >
