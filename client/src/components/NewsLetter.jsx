...
const NewsLetter = () => {
  return (
    <div className="bg-[var(--white-one)] h-[60vh] flex items-center justify-center">
      <div className="flex flex-col items-center max-w-6xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-[#1c1c1c] text-white">
        <Title
          title="Contact Us"
