  ...
  return (
    <div className="py-28 md:pb-36 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32 text-[var(--black-one)] bg-[var(--white-one)]">
      ...
      <div className="max-w-6xl mt-8 w-full">
        ...
        border-gray-400 font-medium text-base py-3"
        >
        ...
        {bookings.map((booking) => (
          <div
            key={booking._id}
            className="grid bg-[var(--white-one)] grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-400 py-6 first:border-t"
          >
            {/* ------ Hotel Details ---- */}
            <div className="flex gap-6 flex-col md:flex-row">
              <img
                ...
                alt="hotel-img"
                className="w-44 h-32  md:w-44 md:h-32 rounded-xl shadow-xl object-cover"
              />

              <div className="flex flex-col gap-1 max-md:mt-3 min-md:ml-4">
                <p className="text-2xl font-[500]"> {booking.hotel.name}</p>
